...
rm *.cert keystore* truststore*

keytool -genkey -keyalg RSA -keystore ./keystore_client -alias clientKey -dname "CN=Client, OU=Jersey, O=hillc"
...
keytool -genkey -keyalg RSA -keystore ./keystore_server -alias serverKey -dname "CN=localhost, OU=Jersey, O=hillc"
